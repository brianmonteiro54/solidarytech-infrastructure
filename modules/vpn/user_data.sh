...
# =============================================================================
# Script baseado no togglemaster (testado e funcional).
# Única diferença: tags Docker pinadas (sem `latest`) — feedback do avaliador.
# =============================================================================

# Atualizar pacotes
sudo apt-get update -y

# Instalar Docker (script oficial — instala daemon + plugin compose v2 junto)
curl -fsSL https://get.docker.com/ | sh

# Instalar Docker Compose v1 (binário legado) - usado como fallback
